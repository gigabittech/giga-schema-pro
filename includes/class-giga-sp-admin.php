							...
							<div class="giga-sp-header-main">
								<div class="giga-sp-header-left">
									...
									<div class="giga-sp-header-title">
										...
										<p class="giga-sp-header-subtitle">
											<?php esc_html_e('Advanced JSON-LD Schema Generation for WordPress', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
								<div class="giga-sp-header-actions">
									<?php if (!$is_pro): ?>
										<a href="#" class="giga-btn giga-btn-primary"
											onclick="window.location.href='?page=giga-schema-pro-settings'; return false;">
											<span class="dashicons dashicons-star-filled"></span>
											<?php esc_html_e('Upgrade to Pro', 'giga-schema-pro'); ?>
										</a>
									<?php endif; ?>
									<a href="#" class="giga-btn giga-btn-secondary"
										onclick="window.location.href='?page=giga-schema-pro-settings'; return false;">
						...
						<div class="giga-card">
							...
							<div class="giga-card-body">
								<div class="giga-checklist">
									<a href="?page=giga-schema-pro-settings"
										class="giga-check-item <?php echo $org_set ? 'completed' : ''; ?>">
										<div class="giga-check-icon"></div>
										<div class="giga-check-content">
											<div class="giga-check-title">
												<?php esc_html_e('Configure Organization Info', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-check-description">
												<?php esc_html_e('Set your site name, logo, and social profiles', 'giga-schema-pro'); ?>
											</div>
										</div>
										<?php if ($org_set): ?>
									...
									<?php if ($woo_active): ?>
										<a href="?page=giga-schema-pro-woo"
											class="giga-check-item <?php echo $woo_set ? 'completed' : ''; ?>">
											<div class="giga-check-icon"></div>
											<div class="giga-check-content">
												<div class="giga-check-title">
													<?php esc_html_e('Configure WooCommerce Settings', 'giga-schema-pro'); ?>
												</div>
												<div class="giga-check-description">
													<?php esc_html_e('Set default brand, shipping rates, and return policies', 'giga-schema-pro'); ?>
												</div>
											</div>
											<?php if ($woo_set): ?>
												<span class="giga-sp-badge giga-sp-pass">✓ Done</span>
									...
									<a href="?page=giga-schema-pro-rules"
										class="giga-check-item <?php echo $analytics['rules_active'] > 0 ? 'completed' : ''; ?>">
										<div class="giga-check-icon"></div>
										<div class="giga-check-content">
											<div class="giga-check-title">
												<?php esc_html_e('Create Auto-Generation Rules', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-check-description">
												<?php esc_html_e('Set rules to automatically apply schema to content', 'giga-schema-pro'); ?>
											</div>
										</div>
						...
						<div class="giga-card">
							...
							<div class="giga-card-body">
								<div class="giga-action-grid">
									<a href="#" class="giga-action-item"
										onclick="window.location.href='?page=giga-schema-pro-validation'; return false;">
										<div class="giga-action-icon">🔍</div>
										<div class="giga-action-title"><?php esc_html_e('Validate Schema', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-action-description">
											<?php esc_html_e('Test all pages against Google standards', 'giga-schema-pro'); ?>
										</div>
									</a>

									<a href="#" class="giga-action-item"
										onclick="window.location.href='?page=giga-schema-pro-rules'; return false;">
										<div class="giga-action-icon">📋</div>
										<div class="giga-action-title"><?php esc_html_e('Manage Rules', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-action-description">
											<?php esc_html_e('Configure auto-generation rules', 'giga-schema-pro'); ?>
										</div>
									</a>

									<a href="#" class="giga-action-item"
										onclick="window.location.href='?page=giga-schema-pro-types'; return false;">
										<div class="giga-action-icon">🏷️</div>
										<div class="giga-action-title"><?php esc_html_e('Schema Types', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-action-description">
											<?php esc_html_e('View and manage all schema types', 'giga-schema-pro'); ?>
										</div>
									</a>

									<?php if ($woo_active): ?>
										<a href="#" class="giga-action-item"
											onclick="window.location.href='?page=giga-schema-pro-woo'; return false;">
											<div class="giga-action-icon">🛒</div>
											<div class="giga-action-title"><?php esc_html_e('WooCommerce', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-action-description">
												<?php esc_html_e('Configure product schema settings', 'giga-schema-pro'); ?>
											</div>
										</a>
									<?php endif; ?>
								</div>
							...
							<div class="giga-card-body">
								<div class="giga-performance-metrics">
									<div class="giga-metric-item">
										<div class="giga-metric-label"><?php esc_html_e('Schema Coverage', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-metric-value">
											<?php echo esc_html(round(($analytics['pages_with_schema'] / max(1, $analytics['total_pages'])) * 100)); ?>%
										</div>
									</div>

									<div class="giga-progress-bar">
										<div class="giga-progress-fill"
											data-progress="<?php echo esc_attr(round(($analytics['pages_with_schema'] / max(1, $analytics['total_pages'])) * 100)); ?>">
										</div>
										<div class="giga-progress-text">
											<?php echo esc_html(round(($analytics['pages_with_schema'] / max(1, $analytics['total_pages'])) * 100)); ?>%
										</div>
									</div>
									...
									<div class="giga-metrics-grid">
										<div class="giga-metric-item">
											<div class="giga-metric-label"><?php esc_html_e('Total Pages', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-metric-value"><?php echo esc_html($analytics['total_pages']); ?>
											</div>
										</div>

										<div class="giga-metric-item">
											<div class="giga-metric-label"><?php esc_html_e('Schema Pages', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-metric-value">
												<?php echo esc_html($analytics['pages_with_schema']); ?>
											</div>
										</div>

										<div class="giga-metric-item">
											<div class="giga-metric-label"><?php esc_html_e('Validated', 'giga-schema-pro'); ?>
											</div>
											<div class="giga-metric-value">
												<?php echo esc_html($analytics['validation_passed']); ?>
											</div>
										</div>

										<div class="giga-metric-item">
											<div class="giga-metric-label"><?php esc_html_e('Issues', 'giga-schema-pro'); ?></div>
											<div class="giga-metric-value" style="color: #ef4444;">
												<?php echo esc_html($analytics['validation_failed']); ?>
											</div>
										</div>
									</div>
								</div>
		...
		public function render_rules()
		{
			...
			<div class="giga-sp-admin">
				<div class="giga-sp-container">
							...
							<div class="giga-sp-header-main">
								<div class="giga-sp-header-left">
									...
									<div class="giga-sp-header-title">
										...
										<p class="giga-sp-header-subtitle">
											<?php esc_html_e('Configure automatic schema generation rules. Rules are applied in order of priority.', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
								<div class="giga-sp-header-actions">
					...
					<div class="giga-stats-grid">
						<div class="giga-stat-card">
							<div class="giga-stat-header">
								...
								<div class="giga-stat-content">
									...
									<p><?php esc_html_e('Total Rules', 'giga-schema-pro'); ?></p>
								</div>
								<?php if (count($rules) > 0): ?>
									<div class="giga-stat-trend">Active</div>
								<?php else: ?>
									<div class="giga-stat-trend">Empty</div>
								<?php endif; ?>
							</div>
						</div>
						...
						<div class="giga-stat-card">
							<div class="giga-stat-header">
								...
								<div class="giga-stat-content">
									<h3><?php echo esc_html(count(array_filter($rules, function ($r) {
										return !empty($r['enabled']);
									}))); ?>
									</h3>
									<p><?php esc_html_e('Enabled Rules', 'giga-schema-pro'); ?></p>
								</div>
								<?php if (
									count(array_filter($rules, function ($r) {
									return !empty($r['enabled']);
								})) > 0
								): ?>
									<div class="giga-stat-trend">Active</div>
								<?php else: ?>
									<div class="giga-stat-trend">Setup</div>
								<?php endif; ?>
							</div>
						</div>
						...
						<div class="giga-stat-card">
							<div class="giga-stat-header">
								<div class="giga-stat-icon" style="background: #6366f1; color: white;">🎯</div>
								<div class="giga-stat-content">
									<h3><?php echo esc_html(count($all_types['free'])); ?></h3>
									<p><?php esc_html_e('Schema Types', 'giga-schema-pro'); ?></p>
								</div>
								<div class="giga-stat-trend">Available</div>
							</div>
						</div>
					</div>
					...
					<!-- Rules Filter Tabs -->
					<div class="giga-tabs">
						<a href="#all-rules" class="giga-sp-tab active" onclick="return false;">
							<span class="dashicons dashicons-list-view"></span>
							<?php esc_html_e('All Rules', 'giga-schema-pro'); ?>
						</a>
						<?php if ($is_pro): ?>
							<a href="#enabled-rules" class="giga-sp-tab" onclick="return false;">
								<span class="dashicons dashicons-yes"></span>
								<?php esc_html_e('Enabled', 'giga-schema-pro'); ?>
							</a>
							<a href="#disabled-rules" class="giga-sp-tab" onclick="return false;">
								<span class="dashicons dashicons-no"></span>
								<?php esc_html_e('Disabled', 'giga-schema-pro'); ?>
							</a>
						<?php endif; ?>
					</div>
						...
						<div class="giga-card-body">
							<?php if (empty($rules)): ?>
								<div class="giga-empty-state">
									...
									<p><?php esc_html_e('Create rules to automatically apply schema markup to your content based on conditions.', 'giga-schema-pro'); ?>
									</p>
									<?php if ($is_pro): ?>
										...
										<?php foreach ($rules as $rule): ?>
											<div class="giga-rule-card <?php echo $rule['enabled'] ? 'active' : ''; ?>">
												<div class="giga-rule-header">
													<div class="giga-rule-info">
														...
														<div class="giga-rule-meta">
															<span
																class="giga-rule-target"><?php echo esc_html($rule['target_type']); ?></span>
															<span class="giga-rule-priority">Priority:
																<?php echo esc_html($rule['priority']); ?></span>
														</div>
													</div>
												...
												<div class="giga-rule-conditions">
													...
													<div class="giga-rule-conditions-content">
														<?php if (empty($rule['conditions'])): ?>
															<span
																class="giga-rule-no-conditions"><?php esc_html_e('No conditions - applies to all content of this type', 'giga-schema-pro'); ?></span>
														<?php else: ?>
												...
												<div class="giga-rule-actions">
													<?php if ($is_pro): ?>
														<button type="button" class="giga-btn giga-btn-secondary" data-action="edit"
															data-rule-id="<?php echo esc_attr($rule['id']); ?>">
															<span class="dashicons dashicons-edit"></span>
															<?php esc_html_e('Edit', 'giga-schema-pro'); ?>
														</button>
														<button type="button" class="giga-btn giga-btn-secondary" data-action="delete"
															data-rule-id="<?php echo esc_attr($rule['id']); ?>">
							...
							<div class="giga-sp-header-main">
								<div class="giga-sp-header-left">
									...
									<div class="giga-sp-header-title">
										...
										<p class="giga-sp-header-subtitle">
											<?php esc_html_e('Browse and manage all supported schema types', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
								<div class="giga-sp-header-actions">
					...
					<div id="all-types" class="giga-panel">
						<div class="giga-schema-grid">
							...
							foreach ($all_schema_types as $schema_type):
								...
								?>
								<div class="giga-schema-card" data-schema-type="<?php echo esc_attr($schema_type['name']); ?>"
									data-schema-category="<?php echo esc_attr($this->get_schema_category($schema_type['name'])); ?>">
									<div class="giga-schema-icon">
										<?php echo esc_html($icon); ?>
									</div>
									<h3 class="giga-schema-title"><?php echo esc_html($schema_type['name']); ?></h3>
									<p class="giga-schema-description">
										<?php echo esc_html($this->get_schema_type_description($schema_type['name'])); ?>
									</p>
						...
						<div class="giga-schema-grid">
							<?php foreach ($all_types['free'] as $type):
								...
								<div class="giga-schema-card" data-schema-type="<?php echo esc_attr($type); ?>">
									...
									<p class="giga-schema-description">
										<?php echo esc_html($this->get_schema_type_description($type)); ?>
									</p>
									<div class="giga-schema-footer">
					...
					<?php else: ?>
						<div id="pro-types" class="giga-panel" style="display: none;">
							<div class="giga-card">
								...
								<div class="giga-card-body">
									<p><?php esc_html_e('Unlock 15+ additional schema types with the Pro version:', 'giga-schema-pro'); ?>
									</p>
							...
							<div class="giga-sp-header-main">
								<div class="giga-sp-header-left">
									...
									<div class="giga-sp-header-title">
										...
										<p class="giga-sp-header-subtitle">
											<?php esc_html_e('Test your schema markup against Google Rich Results requirements', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
								<div class="giga-sp-header-actions">
									<a href="#" class="giga-btn giga-btn-secondary"
										onclick="window.location.href='?page=giga-schema-pro'; return false;">
								...
								<div class="giga-bulk-validation">
									<div class="giga-validation-progress" id="giga-validation-progress" style="display: none;">
										...
										<div class="giga-validation-stats">
											<span id="giga-validation-current">0</span> / <span id="giga-validation-total">0</span>
											items
										</div>
									</div>
									...
									<div class="giga-validation-options">
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Validate Schema Types', 'giga-schema-pro'); ?></span>
											</label>
										</div>
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Validate Structure', 'giga-schema-pro'); ?></span>
											</label>
										</div>
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Validate for Rich Results', 'giga-schema-pro'); ?></span>
											</label>
										</div>
									</div>
								...
								<div id="giga-sp-validation-results">
									...
									<?php else: ?>
										<div class="giga-empty-state">
											...
											<p><?php esc_html_e('Run a validation to see detailed results and recommendations for improving your schema markup.', 'giga-schema-pro'); ?>
											</p>
											<button type="button" class="giga-btn giga-btn-primary"
												onclick="$('#giga-start-bulk-validation').click();">
							...
							<div class="giga-card-body">
								<div class="giga-pro-features">
									<div class="giga-pro-feature-list">
										<div class="giga-pro-feature">
											...
											<div>
												...
												<p><?php esc_html_e('Validate all WooCommerce products at once with detailed reporting', 'giga-schema-pro'); ?>
												</p>
											</div>
										</div>
										...
										<div class="giga-pro-feature">
											...
											<div>
												...
												<p><?php esc_html_e('Test against Google\'s latest Rich Results requirements', 'giga-schema-pro'); ?>
												</p>
											</div>
										</div>
										...
										<div class="giga-pro-feature">
											...
											<div>
												...
												<p><?php esc_html_e('Get specific recommendations to fix schema issues', 'giga-schema-pro'); ?>
												</p>
											</div>
										</div>
										...
										<div class="giga-pro-feature">
											...
											<div>
												...
												<p><?php esc_html_e('Generate and download detailed validation reports', 'giga-schema-pro'); ?>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="giga-upgrade-section">
										...
										<p><?php esc_html_e('Unlock advanced validation features and improve your search visibility', 'giga-schema-pro'); ?>
										</p>
										<a href="#" class="giga-btn giga-btn-primary">
											<span class="dashicons dashicons-star-filled"></span>
							...
							<div class="giga-sp-header-main">
								<div class="giga-sp-header-left">
									...
									<div class="giga-sp-header-title">
										...
										<p class="giga-sp-header-subtitle">
											<?php esc_html_e('Configure schema markup for your WooCommerce products', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
								<div class="giga-sp-header-actions">
							...
							<div class="giga-woo-status">
								<div class="giga-status-item">
									...
									<div class="giga-status-content">
										<div class="giga-status-title">
											<?php esc_html_e('WooCommerce Detected', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-status-description">
											<?php esc_html_e('WooCommerce is active and ready for schema integration', 'giga-schema-pro'); ?>
										</div>
									</div>
								</div>
								<div class="giga-status-item">
									<div class="giga-status-icon <?php echo !empty($default_brand) ? 'active' : 'inactive'; ?>">
										<span
											class="dashicons <?php echo !empty($default_brand) ? 'dashicons-yes' : 'dashicons-no'; ?>"></span>
									</div>
									<div class="giga-status-content">
										<div class="giga-status-title">
											<?php esc_html_e('Brand Configuration', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-status-description">
											<?php echo !empty($default_brand) ? esc_html__('Default brand is configured', 'giga-schema-pro') : esc_html__('Set a default brand for products', 'giga-schema-pro'); ?>
										</div>
									</div>
								</div>
								<div class="giga-status-item">
									<div class="giga-status-icon <?php echo !empty($shipping_rate) ? 'active' : 'inactive'; ?>">
										<span
											class="dashicons <?php echo !empty($shipping_rate) ? 'dashicons-yes' : 'dashicons-no'; ?>"></span>
									</div>
									<div class="giga-status-content">
										<div class="giga-status-title">
											<?php esc_html_e('Shipping Configuration', 'giga-schema-pro'); ?>
										</div>
										<div class="giga-status-description">
											<?php echo !empty($shipping_rate) ? esc_html__('Shipping rates are configured', 'giga-schema-pro') : esc_html__('Set default shipping rates', 'giga-schema-pro'); ?>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="giga-settings-grid">
								<div class="giga-settings-column">
									<div class="giga-form-group">
										...
										<input type="number" step="0.01" name="shipping_rate" id="shipping_rate"
											value="<?php echo esc_attr($shipping_rate); ?>" class="giga-form-input"
											placeholder="0.00">
										<p class="giga-form-description">
											<?php esc_html_e('Default shipping cost for all products. Leave empty to disable shipping details in schema.', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<input type="text" name="shipping_currency" id="shipping_currency"
											value="<?php echo esc_attr($shipping_currency); ?>" class="giga-form-input"
											placeholder="USD">
										<p class="giga-form-description">
											<?php esc_html_e('Currency code for shipping (e.g., USD, EUR). Leave empty to use WooCommerce default.', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<input type="number" name="return_days" id="return_days"
											value="<?php echo esc_attr($return_days); ?>" class="giga-form-input" min="0">
										<p class="giga-form-description">
											<?php esc_html_e('Number of days customers can return products.', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<select name="return_policy_category" id="return_policy_category" class="giga-form-select">
											<option value="https://schema.org/MerchantReturnFiniteReturnWindow" <?php selected($return_policy_category, 'https://schema.org/MerchantReturnFiniteReturnWindow'); ?>>
												<?php esc_html_e('Finite Return Window', 'giga-schema-pro'); ?>
											</option>
											<option value="https://schema.org/MerchantReturnUnlimitedWindow" <?php selected($return_policy_category, 'https://schema.org/MerchantReturnUnlimitedWindow'); ?>>
												<?php esc_html_e('Unlimited Return Window', 'giga-schema-pro'); ?>
											</option>
											<option value="https://schema.org/MerchantReturnNotPermitted" <?php selected($return_policy_category, 'https://schema.org/MerchantReturnNotPermitted'); ?>>
												<?php esc_html_e('Returns Not Permitted', 'giga-schema-pro'); ?>
											</option>
										</select>
										<p class="giga-form-description">
											<?php esc_html_e('Choose the appropriate return policy category for your business.', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
									...
									<div class="giga-info-card">
										...
										<div class="giga-info-content">
											<ul class="giga-info-list">
												<li><?php esc_html_e('Improved product visibility in search results', 'giga-schema-pro'); ?>
												</li>
												<li><?php esc_html_e('Rich snippets in Google search', 'giga-schema-pro'); ?></li>
												<li><?php esc_html_e('Better shopping experience for customers', 'giga-schema-pro'); ?>
												</li>
												<li><?php esc_html_e('Enhanced local SEO for physical stores', 'giga-schema-pro'); ?>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="giga-settings-grid">
								<div class="giga-settings-column">
									<div class="giga-form-group">
										...
										<input type="text" name="default_brand" id="default_brand"
											value="<?php echo esc_attr($default_brand); ?>" class="giga-form-input"
											placeholder="Your Brand Name">
										<p class="giga-form-description">
											<?php esc_html_e('Default brand name for products. Will be used if no product-specific brand is set.', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<input type="text" name="gtin_field" id="gtin_field"
											value="<?php echo esc_attr($gtin_field); ?>" class="giga-form-input"
											placeholder="_gtin">
										<p class="giga-form-description">
											<?php esc_html_e('Custom field name for GTIN (Global Trade Item Number). Default: _gtin', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<input type="text" name="mpn_field" id="mpn_field"
											value="<?php echo esc_attr($mpn_field); ?>" class="giga-form-input" placeholder="_mpn">
										<p class="giga-form-description">
											<?php esc_html_e('Custom field name for MPN (Manufacturer Part Number). Default: _mpn', 'giga-schema-pro'); ?>
										</p>
									</div>
									...
									<div class="giga-form-group">
										...
										<input type="text" name="brand_field" id="brand_field"
											value="<?php echo esc_attr($brand_field); ?>" class="giga-form-input"
											placeholder="_brand">
										<p class="giga-form-description">
											<?php esc_html_e('Custom field name for Brand. Default: _brand', 'giga-schema-pro'); ?>
										</p>
									</div>
								</div>
									...
									<div class="giga-field-guide">
										...
										<div class="giga-guide-content">
											<div class="giga-guide-section">
												...
												<p><?php esc_html_e('Configure these custom fields to enhance your product schema with additional identifiers:', 'giga-schema-pro'); ?>
												</p>
											...
											<div class="giga-guide-section">
												...
												<ol class="giga-guide-list">
													<li><?php esc_html_e('Go to WooCommerce → Products → Attributes', 'giga-schema-pro'); ?>
													</li>
													<li><?php esc_html_e('Create new attributes for GTIN, MPN, and Brand', 'giga-schema-pro'); ?>
													</li>
													<li><?php esc_html_e('Assign these attributes to your products', 'giga-schema-pro'); ?>
													</li>
													<li><?php esc_html_e('The schema will automatically include these values', 'giga-schema-pro'); ?>
													</li>
												</ol>
											</div>
										</div>
									...
									<div class="giga-advanced-section">
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Enable Aggregate Rating Schema', 'giga-schema-pro'); ?></span>
											</label>
											<p class="giga-form-description">
												<?php esc_html_e('Automatically includes product ratings and reviews in schema markup (Pro feature).', 'giga-schema-pro'); ?>
											</p>
										</div>
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Enable Individual Review Schema', 'giga-schema-pro'); ?></span>
											</label>
											<p class="giga-form-description">
												<?php esc_html_e('Includes individual customer reviews in schema markup (Pro feature).', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
									...
									<div class="giga-advanced-section">
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Auto-generate schema for all products', 'giga-schema-pro'); ?></span>
											</label>
											<p class="giga-form-description">
												<?php esc_html_e('Automatically apply schema to all WooCommerce products.', 'giga-schema-pro'); ?>
											</p>
										</div>
										...
										<div class="giga-form-group">
											<label class="giga-form-label">
												...
												<span
													class="giga-checkbox-label"><?php esc_html_e('Include product images in schema', 'giga-schema-pro'); ?></span>
											</label>
											<p class="giga-form-description">
												<?php esc_html_e('Add product images to schema markup for rich results.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
								...
								<div class="giga-settings-column">
									<div class="giga-debug-info">
										...
										<div class="giga-debug-content">
											<div class="giga-debug-item">
												<span
													class="giga-debug-label"><?php esc_html_e('Active Products:', 'giga-schema-pro'); ?></span>
												<span
													class="giga-debug-value"><?php echo esc_html($this->get_product_count()); ?></span>
											</div>
											<div class="giga-debug-item">
												<span
													class="giga-debug-label"><?php esc_html_e('Schema Generated:', 'giga-schema-pro'); ?></span>
												<span
													class="giga-debug-value"><?php echo esc_html($this->get_schema_count()); ?></span>
											</div>
											<div class="giga-debug-item">
												<span
													class="giga-debug-label"><?php esc_html_e('Last Updated:', 'giga-schema-pro'); ?></span>
									...
									<div class="giga-actions-card">
										...
										<div class="giga-actions-content">
											<button type="button" class="giga-btn giga-btn-secondary"
												onclick="gigaRegenerateAllSchema();">
												<span class="dashicons dashicons-update"></span>
												<?php esc_html_e('Regenerate All Schema', 'giga-schema-pro'); ?>
											</button>
											<button type="button" class="giga-btn giga-btn-secondary"
												onclick="gigaClearSchemaCache();">
												<span class="dashicons dashicons-trash"></span>
			...
			<div class="wrap">
				...
				<div class="giga-settings-header">
					<div class="giga-settings-intro">
						<p><?php esc_html_e('Configure your organization information and social profiles to enhance your schema markup.', 'giga-schema-pro'); ?>
						</p>
					</div>
				</div>
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="text" name="organization_name" id="organization_name"
												value="<?php echo esc_attr($org_name); ?>" class="giga-form-input" required>
											<p class="giga-form-description">
												<?php esc_html_e('The official name of your organization.', 'giga-schema-pro'); ?>
											</p>
										</div>
										...
										<div class="giga-form-group">
											...
											<input type="url" name="organization_url" id="organization_url"
												value="<?php echo esc_attr($org_url); ?>" class="giga-form-input" required>
											<p class="giga-form-description">
												<?php esc_html_e('The main website URL of your organization.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
								...
								<div class="giga-settings-card">
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="url" name="organization_logo" id="organization_logo"
												value="<?php echo esc_attr($org_logo); ?>" class="giga-form-input">
											<p class="giga-form-description">
												<?php esc_html_e('Full URL to your organization logo image (recommended: 600x600px).', 'giga-schema-pro'); ?>
											</p>

											<?php if (!empty($org_logo)): ?>
												<div class="giga-logo-preview">
													<img src="<?php echo esc_url($org_logo); ?>"
														alt="<?php esc_attr_e('Organization Logo', 'giga-schema-pro'); ?>"
														class="giga-logo-img">
												</div>
											<?php endif; ?>
										</div>
							...
							<div class="giga-settings-column">
								<div class="giga-settings-card">
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<textarea name="organization_description" id="organization_description" rows="8"
												class="giga-form-input" required><?php echo esc_textarea($org_desc); ?></textarea>
											<p class="giga-form-description">
												<?php esc_html_e('A detailed description of your organization. This will be used in schema markup.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
								...
								<div class="giga-settings-card">
									...
									<div class="giga-card-content">
										<div class="giga-debug-item">
											<span
												class="giga-debug-label"><?php esc_html_e('Organization Name', 'giga-schema-pro'); ?></span>
											<span
												class="giga-debug-value"><?php echo !empty($org_name) ? esc_html($org_name) : esc_html__('Not set', 'giga-schema-pro'); ?></span>
										</div>
										<div class="giga-debug-item">
											<span class="giga-debug-label"><?php esc_html_e('Logo', 'giga-schema-pro'); ?></span>
											<span
												class="giga-debug-value"><?php echo !empty($org_logo) ? esc_html__('Set', 'giga-schema-pro') : esc_html__('Not set', 'giga-schema-pro'); ?></span>
										</div>
										<div class="giga-debug-item">
											<span
												class="giga-debug-label"><?php esc_html_e('Social Profiles', 'giga-schema-pro'); ?></span>
											<span
												class="giga-debug-value"><?php echo (!empty($social_facebook) || !empty($social_twitter) || !empty($social_linkedin) || !empty($social_instagram)) ? esc_html__('Connected', 'giga-schema-pro') : esc_html__('Not connected', 'giga-schema-pro'); ?></span>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="url" name="social_facebook" id="social_facebook"
												value="<?php echo esc_attr($social_facebook); ?>" class="giga-form-input">
											<p class="giga-form-description">
												<?php esc_html_e('Your Facebook profile or page URL.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="url" name="social_twitter" id="social_twitter"
												value="<?php echo esc_attr($social_twitter); ?>" class="giga-form-input">
											<p class="giga-form-description">
												<?php esc_html_e('Your Twitter profile URL.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="url" name="social_linkedin" id="social_linkedin"
												value="<?php echo esc_attr($social_linkedin); ?>" class="giga-form-input">
											<p class="giga-form-description">
												<?php esc_html_e('Your LinkedIn profile or company page URL.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="giga-card-content">
										<div class="giga-form-group">
											...
											<input type="url" name="social_instagram" id="social_instagram"
												value="<?php echo esc_attr($social_instagram); ?>" class="giga-form-input">
											<p class="giga-form-description">
												<?php esc_html_e('Your Instagram profile URL.', 'giga-schema-pro'); ?>
											</p>
										</div>
									</div>
								</div>
